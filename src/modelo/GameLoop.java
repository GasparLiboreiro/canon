...
public class GameLoop extends Thread{
    ...
    private Function<Double,Void> update;
    private double averageUPS = -1;
    private double averageFPS = -1;

    public GameLoop(Function<Void, Void> function, Function<Double,Void> update) {
    ...
    public void run() {
        ...
        while(isRunning) {
			//update y render
			update.apply((double)(System.currentTimeMillis()-updateTime)/1000);
			updateTime = System.currentTimeMillis();
			updateCount++;
